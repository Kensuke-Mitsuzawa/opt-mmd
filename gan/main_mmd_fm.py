...
flags.DEFINE_float("kernel_d_learning_rate", 2, "Learning rate g-d ratio [2]")
...
flags.DEFINE_boolean("use_scale_kernel", False, "True for visualizing, False for nothing [False]")
flags.DEFINE_boolean("use_gan", False, "True for visualizing, False for nothing [False]")
